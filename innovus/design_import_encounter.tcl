...
# set report format
set_global report_timing_format {instance pin cell net fanout load slew delay arrival edge user_derate }
# set path group
...
checkDesign -all
# saveDesign
saveDesign ./DB/design_import_encounter.enc
